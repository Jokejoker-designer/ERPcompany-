# Thanh Hoai ERP (runtime LOCAL)

> **Monorepo:** package này nằm tại `apps/thanh-hoai-runtime/`.  
> Demo UI React: `apps/cong-trinh-demo/`. Xem root [`README.md`](../../README.md) · [`docs/SECURITY-LOCAL.md`](../../docs/SECURITY-LOCAL.md).
